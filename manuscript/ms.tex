...
\begin{abstract}
    Stars with masses $\gtrsim$ 1.1$M_\odot$ have core convection zones during the main sequence.
    In these \emph{moosive stars}, convection introduces many uncertainties into stellar modeling.
...
\input{appendix_history}

\input{appendix_mask}

\input{appendix_nondim}
